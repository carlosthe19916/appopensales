...
angular.module(ApplicationConfiguration.applicationModuleName).provider('sgIso3166', function() {
...
angular.module(ApplicationConfiguration.applicationModuleName).factory('Iso3166Restangular', ['Restangular', 'sgIso3166', function(Restangular, sgIso3166) {
...
angular.module(ApplicationConfiguration.applicationModuleName).factory('SGCountryCode', ['Iso3166Restangular',  function(Iso3166Restangular) {
    var countryCodeResource = new RestObject('countryCodes', Iso3166Restangular);
    return countryCodeResource;
}]);


angular.module(ApplicationConfiguration.applicationModuleName).factory('SGCountryName', ['Iso3166Restangular',function(Iso3166Restangular) {
    var countryNameResource = new RestObject('countryNames', Iso3166Restangular);
    return countryNameResource;
}]);


angular.module(ApplicationConfiguration.applicationModuleName).factory('SGLanguage', ['Iso3166Restangular',function(Iso3166Restangular) {
    var countryLanguagesResource = new RestObject('countryLanguages', Iso3166Restangular);
    return countryLanguagesResource;
}]);


angular.module(ApplicationConfiguration.applicationModuleName).factory('SGSubdivisionCategory', ['Iso3166Restangular', function(Iso3166Restangular) {
...
angular.module(ApplicationConfiguration.applicationModuleName).factory('SGTerritory', ['Iso3166Restangular',function(Iso3166Restangular) {
